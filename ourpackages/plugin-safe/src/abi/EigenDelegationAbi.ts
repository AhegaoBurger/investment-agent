export const eigenDelegationAbi = [
  {
    inputs: [
      {
  ...
  },
  {
    inputs: [
      ...
      { internalType: "uint64", name: "prevMaxMagnitude", type: "uint64" },
      { internalType: "uint64", name: "newMaxMagnitude", type: "uint64" },
    ],
  ...
  },
  {
    ...
    outputs: [
      { internalType: "uint256", name: "totalQueued", type: "uint256" },
    ],
    stateMutability: "view",
    type: "function",
  },
  {
    inputs: [
      { internalType: "address", name: "staker", type: "address" },
      { internalType: "uint256", name: "curDepositShares", type: "uint256" },
      {
        internalType: "uint64",
  ...
  },
  {
    inputs: [
      { internalType: "address", name: "staker", type: "address" },
      { internalType: "contract IStrategy", name: "strategy", type: "address" },
      { internalType: "uint256", name: "prevDepositShares", type: "uint256" },
      { internalType: "uint256", name: "addedShares", type: "uint256" },
    ],
  ...
  },
  {
    inputs: [
      ...
      { internalType: "uint32", name: "allocationDelay", type: "uint32" },
