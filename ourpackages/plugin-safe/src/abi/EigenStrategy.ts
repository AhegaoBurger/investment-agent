export const eigenStrategy = [
  ...
  { inputs: [], name: "MaxStrategiesExceeded", type: "error" },
  { inputs: [], name: "OnlyDelegationManager", type: "error" },
  { inputs: [], name: "OnlyPauser", type: "error" },
  { inputs: [], name: "OnlyStrategyWhitelister", type: "error" },
  { inputs: [], name: "OnlyUnpauser", type: "error" },
  { inputs: [], name: "SharesAmountTooHigh", type: "error" },
  { inputs: [], name: "SharesAmountZero", type: "error" },
  { inputs: [], name: "SignatureExpired", type: "error" },
  { inputs: [], name: "StakerAddressZero", type: "error" },
  { inputs: [], name: "StrategyNotFound", type: "error" },
  { inputs: [], name: "StrategyNotWhitelisted", type: "error" },
  {
    anonymous: false,
    inputs: [
      {
